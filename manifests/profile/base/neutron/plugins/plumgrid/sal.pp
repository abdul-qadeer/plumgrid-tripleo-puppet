...
# under the License.
#
# == Class: tripleo::profile::base::neutron::plugins::plumgrid::sal
#
...
class tripleo::profile::base::neutron::plugins::plumgrid::sal (
  ...
  $plumgrid_virtual_ip = hiera('neutron::plugins::plumgrid::director_server'),
) {
  ...
  if $step >= 4 or ( $step >= 3 and $sync_db ) {
    ...
    class{'sal':
      ...
      virtual_ip => $plumgrid_virtual_ip,
      rest_port => '9180',
      mgmt_dev => $mgmt_dev,
